...
//#region app/stores/screening.ts
var useScreeningStore = defineStore("screening", {
	state: () => ({
	...
	getters: {
		...
		dominantProblem(state) {
			...
			if (max === physical) return "physical";
	...
	actions: {
		...
		nextBlock() {
			...
			if (this.currentBlock < this.blocks.length - 1) this.currentBlock++;
		},
		isLastBlock() {
...
export { useScreeningStore as u };
//# sourceMappingURL=screening-DvSbJSAX.mjs.map
