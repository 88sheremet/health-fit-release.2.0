...
.hero-content { flex: 1; max-width: 65%; }
.hero-title { margin: 0; font-size: 42px; font-weight: 700; color: var(--black1); }
.hero-subtitle { margin-top: 14px; line-height: 1.6; color: var(--grey2); font-size: 16px; }
.hero-book {
...
.action-card {
  ...
  background: var(--glass-heavy); box-shadow: 0 8px 24px var(--shadow-md);
  transition: 0.2s; cursor: pointer;
}
.action-card:active { transform: scale(0.98); }
.note-card { border: 1px solid rgba(251, 140, 0, 0.2); }
.action-icon {
