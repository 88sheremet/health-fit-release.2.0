  ...
  <div class="journal-page">
    ...
    <div class="actions">
      <q-card
        flat
        class="action-card"
        @click="navigateTo(routes.recovery.journalChart)"
      >
        ...
        <div class="action-content">
          <div class="action-title">
            {{ $t("journal.chartAction") }}
          </div>

          <div class="action-subtitle">
            {{ $t("journal.chartActionSubtitle") }}
          </div>
        </div>
      ...
      <q-card flat class="action-card note-card" @click="showNoteDialog = true">
        ...
        <div class="action-content">
          <div class="action-title">
            {{ $t("journal.noteAction") }}
          </div>

          <div class="action-subtitle">
            {{ $t("journal.noteActionSubtitle") }}
          </div>
        </div>
      ...
      >
        ...
        <div class="action-content">
          <div class="action-title">
            {{ $t("journal.archiveAction") }}
          </div>

          <div class="action-subtitle">
            {{ $t("journal.archiveActionSubtitle") }}
          </div>
        </div>
