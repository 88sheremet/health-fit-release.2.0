...
.result-page { min-height: 100vh; padding: 24px 20px 140px; background: var(--bg-gradient-purple); }
...
.card-title { font-size: 15px; font-weight: 700; color: var(--purple); margin-bottom: 14px; }
