...
- Name: onboarding.spec.ts >> Welcome page >> has start button that navigates to screening
- Location: e2e\onboarding.spec.ts:13:3
...
Expected pattern: /\/screening/
Received string:  "http://localhost:3000/login"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    2 × locator resolved to <html dir="ltr" lang="en-US">…</html>
      - unexpected value "http://localhost:3000/welcome"
    11 × locator resolved to <html dir="ltr" lang="en-US">…</html>
