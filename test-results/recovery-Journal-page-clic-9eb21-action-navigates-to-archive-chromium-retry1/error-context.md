...
- Name: recovery.spec.ts >> Journal page >> clicking archive action navigates to archive
- Location: e2e\recovery.spec.ts:98:3
...
Call log:
  - waiting for locator('.action-card').nth(2)
