...
- Name: onboarding.spec.ts >> Questions flow >> answer buttons toggle active class on click
- Location: e2e\onboarding.spec.ts:62:3
...
Call log:
  - waiting for locator('.question-card').first().locator('.answer-btn').first()
