...
- Name: onboarding.spec.ts >> Questions flow >> shows block counter and progress bar
- Location: e2e\onboarding.spec.ts:53:3
...
Call log:
  ...
  - waiting for locator('.block-counter')
