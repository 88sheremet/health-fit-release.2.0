...
- Name: recovery.spec.ts >> Daily page >> shows bottom navigation
- Location: e2e\recovery.spec.ts:55:3
...
Locator:  locator('.bottom-navigation, nav, [class*=\'bottom\']').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.bottom-navigation, nav, [class*=\'bottom\']').first()
    7 × locator resolved to <div class="q-notifications__list q-notifications__list--bottom fixed column no-wrap items-start"></div>
