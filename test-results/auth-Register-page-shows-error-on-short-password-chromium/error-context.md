...
Error: locator.fill: Error: strict mode violation: locator('input[type="password"]') resolved to 2 elements:
    1) <input value="" tabindex="0" type="password" aria-label="Пароль" autocomplete="new-password" class="q-field__native q-placeholder" id="f_afe00c29-620c-4502-9946-814f321da030"/> aka getByRole('textbox', { name: 'Пароль', exact: true })
    2) <input value="" tabindex="0" type="password" autocomplete="new-password" aria-label="Повторите пароль" class="q-field__native q-placeholder" id="f_58cec0ea-69fa-4e68-bf71-33b73c86e2c7"/> aka getByRole('textbox', { name: 'Повторите пароль' })
