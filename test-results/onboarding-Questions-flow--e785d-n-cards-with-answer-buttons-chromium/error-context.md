...
- Name: onboarding.spec.ts >> Questions flow >> renders question cards with answer buttons
- Location: e2e\onboarding.spec.ts:44:3
...
Locator: locator('.question-card').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.question-card').first()
