...
Error: locator.fill: Error: strict mode violation: locator('input[type="password"]') resolved to 2 elements:
    1) <input value="" tabindex="0" type="password" aria-label="Пароль" autocomplete="new-password" class="q-field__native q-placeholder" id="f_436f0b62-5026-4c63-9181-fc4c92f4364c"/> aka getByRole('textbox', { name: 'Пароль', exact: true })
    2) <input value="" tabindex="0" type="password" autocomplete="new-password" aria-label="Повторите пароль" class="q-field__native q-placeholder" id="f_39210d74-ed23-4b82-ad82-1c418c9ed507"/> aka getByRole('textbox', { name: 'Повторите пароль' })
